...
class Receivings extends Secure_Controller
{
	...
	public function complete()
	{
		...
		$data['trans_total']=$this->receiving_lib->get_trans_total();
        ...
        //if ($data['mode']=='requisition')
		$this->Receiving->remote_req($data['cart']);
	...
	public function requisition_complete()
	{
		if($this->receiving_lib->get_stock_source() != $this->receiving_lib->get_stock_destination()) 
		{
			foreach($this->receiving_lib->get_cart() as $item)
			{
			    ...
			    //$this->Receiving->remote_req($item['item_id'], $item['quantity'],$this->receiving_lib->get_stock_destination(), $this->receiving_lib->get_stock_source());
			}
