...
class Items extends Secure_Controller
{
	...
	*/
	...
	public function generate_barcodes($item_ids_with_qty)
	{
		...
		$this->load->view('barcodes/barcode_new', $data);
	}
	...
	public function save($item_id = -1)
	{
		...
		$item_data = array(
			...
			'custom2' => $this->input->post('custom2') == NULL ? '' : date('Y-m-d', strtotime(str_replace('/', '-', $this->input->post('custom2')))),
