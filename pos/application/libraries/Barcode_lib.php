...
class Barcode_lib
{
	...
	{
		$seed = $barcode_config['barcode_content'] !== "id" && !empty($item['item_number']) ? $item['item_number'] : "sk".$item['item_id'];
	...
	public function display_barcode($item, $barcode_config)
	{
		...
		$display_table .= "<tr><td align='center'>" . $item['name']. "</td></tr>"; 
		//$display_table .= "<tr><td align='center'>MRP: " . to_currency($item['custom3'])."; ".$this->manage_display_layout($barcode_config['barcode_third_row'], $item, $barcode_config). "</td></tr>";
		//$display_table .= "<tr><td align='center'>MRP: " . to_currency($item['custom3'])."; Best Price: ".to_currency(round($item['unit_price']*(1-$item['custom1']/100)))."</td></tr>";
		$display_table .= "<tr><td align='center'>Best Price: ".to_currency(round($item['unit_price']*(1-$item['custom1']/100)))."</td></tr>";
