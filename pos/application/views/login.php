...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . 'Akhila Chaitanya'  . ' | ' .  $this->lang->line('login_login'); ?></title>
	<link rel="shortcut icon" type="image/x-icon" href="images/logo for export.png">
...
<div class="outer">
<div class="vcentered">
	<div id="logo" align="center"><img src="<?php echo base_url();?>/images/logo for export.png" height="100" width="100"></div>
	...
	<div id="login">
		...
		<h1>Sai Krupa Super Market <?php //echo $this->config->item('application_version'); ?></h1>
