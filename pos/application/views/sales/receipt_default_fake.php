...
<div class="receipt_new" style="font-size:<?php echo $this->config->item('receipt_font_size');?>px">
	...
	<table id="receipt_items" >
		<tr style="border-top: solid 2px; border-bottom: solid 2px">
			<th style="width:10%; border-right-style:solid; border-left-style:solid"><?php echo "S.No" ?></th>
			<th style="width:35%; border-right-style:solid"><?php echo "Item Name"; ?></th>
			<th style="border-right-style:solid"><?php echo $this->lang->line('sales_quantity'); ?></th>
			<th style="width:20%; border-right-style:solid"><?php echo"MRP"; ?>
			<th style="width:15%; border-right-style:solid"><?php echo "Special<br>Price";?>
			<th style="text-align:right; width:20%; border-right-style:solid" class="total-value"><?php echo "Amount";?></th>
		</tr>
		<?php
		$sno=0;
		$total_qty=0;
		...
		?>
			<tr>
			    <td style="border-right-style:solid; border-left-style:solid"><?php $sno++;
				echo $sno;
				?></td>
				
				<td style="border-right-style:solid"><div><?php echo wordwrap(ucfirst($item['name']),20,"<br>\n"); ?></div></td>
				<td style="border-right-style:solid"><?php echo to_quantity_decimals($item['quantity']); ?></td>
				<td style="border-right-style:solid"><?php echo (to_currency($item['MRP'])); ?></td>
				<td style="border-right-style:solid"><?php
				if($item['discount'] > 0)
				{
				...
				?></td>
				<td class="total-value" style="border-right-style:solid"><?php  
				if($item['discount'] > 0)
				{
		...
		<tr style='border-top:2px solid #000000;'>
			<td colspan="3" style="text-align:right;<?php echo $border? 'border-top: 2px solid black;' :''; ?>"> <span style= "font-size:17px; font-style:bold">Net Amount:</span> </td>
			<td style="text-align:right;<?php //echo $border? 'border-top: 2px solid black;' :''; ?>"><span style= "font-size:17px; font-style:bold"><?php echo to_currency($total); ?></span></td>
		</tr>
		<tr>
			<td colspan="3" style="text-align:right;<?php //echo $border? 'border-top: 2px solid black;' :''; ?>"> <span style= "font-size:17px; font-style:bold">Your Savings:</span> </td>
			<td style="text-align:right;<?php //echo $border? 'border-top: 2px solid black;' :''; ?>"><span style= "font-size:17px; font-style:bold"><?php echo to_currency($total_mrp-$total); ?></span></td>
		</tr>
