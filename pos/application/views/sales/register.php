			...
			<ul>
				...
				?>
					...
					<li class="pull-left">
						...
						echo form_dropdown('stock_location', $stock_locations, $my_location, array('class'=>'selectpicker show-menu-arrow', 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit'));
						?>
					</li>
				<?php
				}
							...
							?>
								<div class="col-xs-6">
									<label for="email-receipt" class="control-label checkbox">
										<?php echo form_checkbox(array('name'=>'email_receipt', 'id'=>'email_receipt', 'value'=>1, 'checked'=>1));
										//echo form_checkbox(array('name'=>'email_receipt', 'id'=>'email_receipt', 'value'=>1, 'checked'=>$email_receipt)); ?>
...
{
	if($('select[name="stock_location"]').val()!=<?php echo $stock_location;?>)
	{//$('select[name="stock_location"]').val(<?php echo $my_location;?>);
	$('#mode_form').submit();
	}
	$('select[name="stock_location"]').change(function(){
		$('select[name="stock_location"]').val(<?php echo $my_location;?>);
	});
	$("#item").autocomplete(
	{
