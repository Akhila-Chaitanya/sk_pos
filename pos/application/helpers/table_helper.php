...
function get_items_manage_table_headers()
{
	...
	$headers = array(
		...
		array('custom1' => "Discount"),
		array('final_price'=>"Disc Price"),
		array('custom3' => "MRP"),
		array('custom2'=>"Exp-date"),
		array('quantity' => "Qty"),
...
function get_item_data_row($item, $controller)
{
	...
	return array (
		...
		'final_price' => to_currency ($item->unit_price*(1-($item->custom1/100))),
		'custom3'=>to_currency($item->custom3),
		'custom2'=>date('d-m-Y', strtotime($item->custom2)),
